...
{
public:
    BossEventTrigger(PlayerbotAI* ai, std::string boss_name, uint32 event_id, std::string name = "boss event")
        : Trigger(ai, name, 1)
    {
...
{
public:
    GrobbulusCloudTrigger(PlayerbotAI* ai) : BossEventTrigger(ai, "grobbulus", 2, "grobbulus cloud event") {}
